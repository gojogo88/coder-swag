...
class DataService {
    static let instance = DataService()  // adding static means there will only be 1 copy of DataService in memory (we can only create one DataService (Singleton)
    ...
    private let shirts = [
        ...
        Product(title: "Hustle Delegate Gray", price: "$20", imageName: "shirt04.png"),
    ...
    //will return to whoever calls this func an array of categories
        return categories
    }
